#!/bin/bash
echo "Enable USB Debugging mode in Developer option to avoid errors ..!!"
read -p "Do you want to proceed? (Y/N)" r0h1th
if [[ $r0h1th = [yY] || $r0h1th = [yY][eE][sS] ]];then
./adb reconnect
...
#uncomment the below line to uninstall those apps / remove # for below lines to delete
...
echo Done!!!
echo Now you reboot your Phone to see changes...
else
